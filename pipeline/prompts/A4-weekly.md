...
RUBRIKREGEL: när rubriken refererar ett löfte måste löftets egna nyckelord behållas — komprimera
aldrig så att innebörden ändras. "Avskaffa marknadsskolan" får t.ex. aldrig bli "skolavskaffande"
(låter som att skolan ska avskaffas). Osäker? Använd löftets ord rakt av.
